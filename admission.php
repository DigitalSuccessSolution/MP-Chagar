...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <header class="bg-white shadow-md sticky top-0 z-50">
    ...
    >
      <div class="flex justify-between items-center mb-8">
        ...
        <button
          id="close-menu"
          class="w-8 h-8 flex items-center justify-center text-gray-700 cursor-pointer"
        >
      ...
      <nav class="flex flex-col space-y-4">
        <a
          ...
          >Home</a
        >
        <a href="about.php" class="py-2 border-b border-gray-100 text-primary"
          >About Us</a
        >
      ...
      <div class="mt-8">
        <a
          href="admission.php"
          class="block w-full bg-secondary hover:bg-opacity-90 text-white text-center px-4 py-3 rounded-button font-medium transition whitespace-nowrap cursor-pointer"
          >Apply Now</a
        >
      </div>
    </div>
      ...
      <div class="container mx-auto px-4 relative z-10">
        <div class="text-center text-white">
          ...
          <div class="flex items-center justify-center">
            ...
            <span class="text-secondary">Admissions</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="py-16 bg-white">
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
          <div
            class="bg-primary/5 border-l-4 border-primary p-6 rounded-lg mb-12"
          >
            ...
            <div class="mt-6 flex flex-wrap gap-4">
              ...
              <a
                ...
                class="bg-white border-2 border-primary text-primary hover:bg-primary/5 px-6 py-3 rounded-button font-medium transition whitespace-nowrap cursor-pointer flex items-center"
              >
              ...
              <div class="space-y-8 relative">
                <div class="flex">
                  <div class="flex flex-col items-center mr-4">
                    <div
                      class="w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center relative z-10"
                    >
                      1
                    </div>
                  </div>
  ...
  <a
    ...
    class="bg-primary hover:bg-primary/90 text-white px-6 py-3 rounded-button w-auto font-medium transition whitespace-nowrap cursor-pointer"
  >
    Apply Now
  </a>
</div>
